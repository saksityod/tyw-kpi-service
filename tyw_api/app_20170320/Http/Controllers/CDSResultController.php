...
class CDSResultController extends Controller
{
	...
	public function export(Request $request)
	{
		...
		$query = "
			select distinct r.emp_code, e.emp_name, cds.cds_id, cds.cds_name, 0 as cds_value
			from appraisal_item_result r, employee e, appraisal_item i, kpi_cds_mapping m, cds 
	...
	{
		$items = DB::select("
			select current_appraisal_year from system_config
		");
