...
class AppraisalController extends Controller
{
	...
	public function show(Request $request, $emp_result_id)
	{
		...
		$items = DB::select("
			select b.appraisal_item_name, b.structure_id, c.structure_name, d.form_id, d.app_url, c.nof_target_score, a.*, e.perspective_name, a.weigh_score, f.weigh_score total_weigh_score
