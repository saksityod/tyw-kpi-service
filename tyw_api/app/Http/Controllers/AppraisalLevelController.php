...
class AppraisalLevelController extends Controller
{
	...
	{		
		$items = DB::select("
			SELECT a.appraisal_level_id, a.appraisal_level_name, a.is_all_employee, a.is_active, a.parent_id, a.is_hr, b.appraisal_level_name parent_level_name
			FROM appraisal_level a
			left outer join appraisal_level b
			on a.parent_id = b.appraisal_level_id
