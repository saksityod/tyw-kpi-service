...
class AppraisalItemController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if ($request->form_id == 1) {
			$validator = Validator::make($request->all(), [	
				'appraisal_item_name' => 'required|max:255|unique:appraisal_item,appraisal_item_name,null,appraisal_item_id,appraisal_level_id,' . $request->appraisal_level_id,
	...
	public function update(Request $request, $appraisal_item_id)
	{
		...
		if ($request->form_id == 1) {
			$validator = Validator::make($request->all(), [
				'appraisal_item_name' => 'required|max:255|unique:appraisal_item,appraisal_item_name,'.$appraisal_item_id . ',appraisal_item_id,appraisal_level_id,' . $request->appraisal_level_id,
				'appraisal_level_id' => 'required|integer',
				'perspective_id' => 'required|integer',
				'structure_id' => 'required|integer',
				'uom_id' => 'required|integer',
